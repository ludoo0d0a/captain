<template>
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div class="px-4 py-6 sm:px-0">
        <div class="flex items-center justify-between">
          <div>
            ...
            <h1 class="text-3xl font-bold text-gray-900">Edit Connector</h1>
            <p class="mt-2 text-sm text-gray-600">
              Update your connector configuration and settings.
            </p>
          </div>
        </div>
      </div>
      ...
      <!-- Form -->
      <div v-else-if="connector" class="px-4 sm:px-0">
        <form @submit.prevent="handleSubmit" class="space-y-8">
          ...
          <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  id="type"
                  :value="getConnectorTypeLabel(connector.type)"
                  type="text"
                  disabled
          ...
          <div class="bg-white shadow rounded-lg p-6">
            <h3 class="text-lg font-medium text-gray-900 mb-6">
              {{ getConnectorTypeLabel(connector.type) }} Settings
            </h3>
            
            <!-- GitHub Settings -->
            <div v-if="connector.type === 'github'" class="space-y-6">
              <div>
            ...
            <!-- GitLab Settings -->
            <div v-if="connector.type === 'gitlab'" class="space-y-6">
              <div>
            ...
            <!-- Docker Settings -->
            <div v-if="connector.type === 'docker'" class="space-y-6">
              <div>
            ...
            <!-- Kubernetes Settings -->
            <div v-if="connector.type === 'kubernetes'" class="space-y-6">
              <div>
            ...
            <!-- HTTP Settings -->
            <div v-if="connector.type === 'http'" class="space-y-6">
              <div>
            ...
            <!-- Jenkins Settings -->
            <div v-if="connector.type === 'jenkins'" class="space-y-6">
              <div>
            ...
            <!-- SSH Settings -->
            <div v-if="connector.type === 'ssh'" class="space-y-6">
              <div>
            ...
            <!-- XL Deploy Settings -->
            <div v-if="connector.type === 'xldeploy'" class="space-y-6">
              <div>
            ...
            <div v-if="connector.type === 'googleplaystore'" class="space-y-6">
              <div>
          ...
          <div class="flex justify-end space-x-3">
            ...
            >
              ...
              <span v-else>Update Connector</span>
            </button>
          </div>
        </form>
      </div>
      ...
      <div v-else class="px-4 sm:px-0">
        <div class="bg-white shadow rounded-lg p-6">
          <div class="text-center">
            <h3 class="text-lg font-medium text-gray-900">Connector not found</h3>
...
onMounted(async () => {
  try {
    const response = await $fetch(`/api/connectors/${route.params.name}`)
    connector.value = response.connector
    
    if (connector.value) {
      form.value = {
        name: connector.value.name || '',
        type: connector.value.type || '',
        settings: { ...connector.value.settings } || {},
        credentials: { ...connector.value.credentials } || {}
      }
    }
  } catch (error) {
...
async function handleSubmit() {
  ...
  try {
    await $fetch(`/api/connectors/${route.params.name}`, {
      method: 'PUT',
      body: {
